    ...
    public class NodeOld
    {
        ...
        protected void CreateEmptyNode()
        {
            ...
            if (subject == null || subject == "")
            {
                ...
                subject = GetType().Name + "_" + DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss-ff");
                //Debug.Log(subject);
            }
        }
        #endregion
        ...
        public void FromGraph(RDFGraph rdfGraph, RDFResource RDFSubject)
        {
            ...
            {
                bool found = false;
                Debug.Log("looking for: " +  triplesEnum.Current);
                ...
                foreach (var field in this.GetType().GetFields(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic))
                {
                    ...
                    if (att != null)
                    {
                        ...
                        if (new RDFResource(att.uri + field.Name).ToString() == triplesEnum.Current.Predicate.ToString())
                        {
                            ...
                            Debug.Log("the matching variable has a raw value of:" + val);
        ...
        /// <summary>
        /// Convert the Node to a RDFGraph
        /// </summary>
        /// <returns>the Serialised node as a RDFGraph</returns>
        ...
        /// <summary>
        /// Add a attribute to the Graph
        /// </summary>
        /// <param name="att">the attribute to add</param>
        ...
        void AddToGraph(RDFUriAttribute att, string fieldName, string fieldValue)
        {
            ...
            //Debug.Log("Added Triple: " + fieldName);
        }
